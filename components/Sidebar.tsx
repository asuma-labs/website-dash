                ...
                <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-3 hover:bg-white/[0.05] transition-all duration-300 group">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      <div className="relative w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-sm font-bold border-2 border-white/15 shadow-lg overflow-hidden">
                        {profile?.avatar_url ? (
