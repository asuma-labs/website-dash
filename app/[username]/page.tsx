...
import { Zap, Bot, Activity, TrendingUp, Users, MessageCircle } from 'lucide-react'
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        {statsCards.map(({ label, value, icon: Icon, color, bg }) => (
          <div key={label} className="relative group">
            ...
            <div className={`relative ${bg} border border-gray-800/50 backdrop-blur-sm rounded-2xl p-6 hover:border-gray-700/50 transition-all`}>
      ...
      <div className="relative">
        ...
        <div className="relative bg-gray-900/80 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              ...
              className="relative group px-5 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl font-medium text-sm hover:shadow-lg hover:shadow-green-500/25 transition-all overflow-hidden"
            >
          ...
          {bots?.length === 0 ? (
            <div className="text-center py-16">
              <div className="w-20 h-20 bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Bot size={40} className="text-gray-500" />
              </div>
              <p className="text-gray-400 text-lg mb-2">Belum ada bot</p>
              <p className="text-gray-600 text-sm">Klik "Tambah Bot" untuk memulai petualangan!</p>
            </div>
          ) : (
            <div className="space-y-3">
              {bots?.map((bot: any) => (
                <Link
                  ...
                  className="flex items-center justify-between p-4 bg-gray-800/50 hover:bg-gray-800 rounded-xl transition-all group border border-transparent hover:border-gray-700/50"
                >
